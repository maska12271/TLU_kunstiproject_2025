        ...
        <div className={"authorizationPage"}>
            ...
            <div className={"formCard"}>
                ...
                <div className={"cardForm"}>
                    ...
                    <button className={"modalSubmitButton"}>Saada registreerumistaotlus</button>
                    <div className={"description"}>Sinu taotluse võtab vastu veebilehe administraator ning saadab sulle
