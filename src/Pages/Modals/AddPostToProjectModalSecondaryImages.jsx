...
function AddPostToProjectModalMainPhoto({ setShowAddPostToProjectModalSecondaryImages }) {
  ...
  function closeModal() {
    setClosed(true);
    setTimeout(() => {
      setShowAddPostToProjectModalSecondaryImages(false);
    }, "300");
  }
  //
  ...
  return (
    ...
    >
      <div className={"modalWindow"} onClick={(e) => e.stopPropagation()}>
        ...
        {/*  <div className={"modalDescription"}>Lisa kuni 4 makro pilti siia</div>*/}
...
export default AddPostToProjectModalMainPhoto;
